 ...
 * which is difficult to configure for pretty-printing. This implementation
 * enables pretty-printing easily via a setter/getter.
 * <p/>
 * See <a href=
 * "http://stackoverflow.com/questions/6541757/when-using-spring-mvc-for-rest-how-do-you-enable-jackson-to-pretty-print-render">
 * When using Spring MVC for REST, how do you enable Jackson to pretty-print
 * rendered JSON?</a> and the latest
 * <a href="https://gist.github.com/2423129">Spring Framework incarnation
 * supporting pretty printing</a> (not yet released at the time of writing).
 *
 * @author Les Hazlewood
 */
public class DefaultJacksonHttpMessageConverter
	 ...
	 * {@link org.codehaus.jackson.map.type.TypeFactory#type(java.lang.reflect.Type)},
	...
	protected void writeInternal(Object o, HttpOutputMessage outputMessage)
		...
		JsonEncoding encoding = getEncoding(
